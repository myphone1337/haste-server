...
var MemcachedDocumentStore = function(options) {
  ...
  if (!MemcachedDocumentStore.client) {
    MemcachedDocumentStore._connect(options);
  }
};

// Create a connection
MemcachedDocumentStore._connect = function(options) {
...
MemcachedDocumentStore.prototype.getRecent = function(callback) {
  this.getMetadata([], callback);
};

MemcachedDocumentStore.prototype.getMetadata = function(keys, callback) {
  callback([]);
};
